...
const formSchema = z.object({
   ...
   mileage: z.coerce.number().gte(1, "Must be 1 and above"),
   transmission: z.string(),
   manufacture: z.string().min(1),
   fuelType: z.string(), // e.g., petrol, diesel, electric
   year: z.coerce.number().gte(1, "Must be 1 and above"), // Manufacturing year
